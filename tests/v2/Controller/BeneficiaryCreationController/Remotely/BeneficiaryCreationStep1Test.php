...
{
    private const URL = '/beneficiary/create/1?remotely=1';
    private const FORM_VALUES = [
        'create_beneficiary[user][prenom]' => 'Jean',
        'create_beneficiary[user][nom]' => 'Dupont',
        'create_beneficiary[user][telephone]' => '+33666666666',
        'create_beneficiary[user][email]' => 'jdupond@mail.com',
    ...
    public function provideTestFormIsNotValid(): ?\Generator
    {
        ...
        $values = self::FORM_VALUES;
        $values['create_beneficiary[user][telephone]'] = '';
