...
class DeleteTest extends AbstractControllerTest implements TestRouteInterface
{
    ...
    public function provideTestRoute(): ?\Generator
    {
        ...
        yield 'Should redirect after delete when authenticated as member with relay in common' => [self::URL, 302, MemberFixture::MEMBER_MAIL_WITH_RELAYS_SHARED_WITH_BENEFICIARIES, '/beneficiary/%s/documents'];
