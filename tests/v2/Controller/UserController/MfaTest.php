...
class MfaTest extends AbstractControllerTest implements TestRouteInterface
{
    private const URL = '/user/mfa';
    ...
    public function provideTestRoute(): ?\Generator
    {
        ...
        yield 'Should return 302 status code when authenticated as member in first visit with mfa enabled' => [self::URL, 302, MemberFixture::MEMBER_FIRST_VISIT_WITH_MFA, '/user/redirect-user/'];
