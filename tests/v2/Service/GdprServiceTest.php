...
class GdprServiceTest extends TestCase
{
    ...
    {
        yield 'Should return 364 when password has been updated today' => [new \DateTimeImmutable('now'), 365];
        yield 'Should return 4 when password has been updated 360 days ago' => [(new \DateTimeImmutable('now'))->sub(new \DateInterval('P360D')), 5];
