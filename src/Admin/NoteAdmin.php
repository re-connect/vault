        ...
        $filter
            ...
            ->add('creatorUser', CallbackFilter::class, [
                ...
                'callback' => static function (ProxyQueryInterface $query, string $alias, string $field, FilterData $data): bool {
                    ...
                    $query
                        ->join(CreatorUser::class, 'creator_user', 'WITH', $alias.'.id = creator_user.note')
            ...
            ->add('creatorCentre', CallbackFilter::class, [
                ...
                'callback' => static function (ProxyQueryInterface $query, string $alias, string $field, FilterData $data): bool {
                    ...
                    $query
                        ->join(CreatorCentre::class, 'creator_centre', 'WITH', $alias.'.id = creator_centre.note')
            ...
            ->add('creatorClient', CallbackFilter::class, [
                ...
                'callback' => static function (ProxyQueryInterface $query, string $alias, string $field, FilterData $data): bool {
                    ...
                    $query
                        ->join(CreatorClient::class, 'creator_client', 'WITH', $alias.'.id = creator_client.note')
