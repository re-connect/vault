...
class ClientFixture extends Fixture implements FixtureGroupInterface
{
    public const CLIENTS = [
        [
            ...
            'scopes' => 'centers beneficiaries beneficiaries_create beneficiaries_read documents documents_read documents_create notes contacts_read contacts_create pros events events_read events_create users',
        ],
        [
            ...
            'name' => 'reconnect_pro',
            'grantType' => 'client_credentials',
            'scopes' => 'centers beneficiaries beneficiaries_read beneficiaries_update documents documents_read documents_update notes contacts_read contacts_update pros events events_read events_update users',
        ],
        [
        ...
        [
            ...
            'grantType' => 'client_credentials',
            'scopes' => 'beneficiaries_read beneficiaries_update contacts_read contacts_update documents_read documents_update events_read events_update',
        ],
        [
            'id' => 'read_only_id',
            ...
            'name' => 'read_only',
            'grantType' => 'client_credentials',
            'scopes' => 'beneficiaries_read contacts_read documents_read events_read',
        ],
        [
            'id' => 'create_only_id',
            ...
            'name' => 'create_only',
            'grantType' => 'client_credentials',
            'scopes' => 'beneficiaries_create contacts_create documents_create events_create',
        ],
        [
            'id' => 'no_scopes_id',
