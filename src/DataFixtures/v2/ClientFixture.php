...
class ClientFixture extends Fixture implements FixtureGroupInterface
{
    public const CLIENTS = [
        [
            ...
            'scopes' => 'centers beneficiaries beneficiaries_create beneficiaries_read documents notes contacts_read contacts_create pros events users',
        ],
        [
            ...
            'name' => 'reconnect_pro',
            'grantType' => 'client_credentials',
            'scopes' => 'centers beneficiaries beneficiaries_read beneficiaries_update documents notes contacts_read contacts_update pros events users',
        ],
        [
