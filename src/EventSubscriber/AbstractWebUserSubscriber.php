...
{
    use UserAwareTrait;
    protected const array FIRST_VISIT_ROUTES = ['re_main_change_lang', 'user_delete', 'user_first_visit', 'user_cgs', '2fa_login', 'user_mfa', 'resend_auth_code', 're_admin_annexe'];
