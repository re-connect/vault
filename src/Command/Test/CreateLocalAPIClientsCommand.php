...
class CreateLocalAPIClientsCommand extends Command
{
    ...
    private const string CREATE_LOCAL_CLIENTS = "insert into vault.client (nom, secret, random_id, redirect_uris, allowed_grant_types, dossier_nom, dossier_image, actif, access, newClientIdentifier) values ('local_password', 'local_password_secret', 'local_password_id', 'a:1:{i:0;s:20:\"/user/redirect-user/\";}', 'a:2:{i:0;s:18:\"client_credentials\";i:1;s:13:\"refresh_token\";}', 'local_password', null, 1, 'a:0:{}', 'local_password_id'), ('local_credentials', 'local_credentials_secret', 'local_credentials_id', 'a:1:{i:0;s:20:\"/user/redirect-user/\";}', 'a:2:{i:0;s:18:\"client_credentials\";i:1;s:13:\"refresh_token\";}', 'local_credentials', null, 1, 'a:0:{}', 'local_credentials_id');";
