...
{
    protected const string FLUSH_CACHE_FILE_NAME = 'flush-cache.php';
    protected const string PUBLIC_FILE_PATH = '{{ deploy_dir }}/current/public/';
    protected const string FLUSH_CACHE_FILE_PATH = self::PUBLIC_FILE_PATH.self::FLUSH_CACHE_FILE_NAME;
    protected const string HOME_PAGE_URL = 'https://localhost:8000';
