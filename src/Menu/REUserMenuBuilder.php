    ...
    public function beneficiaireMenu(array $options): ItemInterface
    {
        ...
        if (array_key_exists('small', $options)) {
            $arRoutes = [
                ...
                'beneficiaire.'.$menuTrad.'.monCalendrier' => ['extras' => ['width' => 30, 'title' => $this->translator->trans('benef_new_guide_which_info_icon_2'), 'color' => 'purple', 'image' => 'build/images/icons/rappels_bleu.png', 'imageAct' => 'build/images/icons/rappels_blanc.png'], 'route' => 're_app_evenement_list', 'routeParameters' => ['id' => $beneficiaireId]],
                'beneficiaire.'.$menuTrad.'.mesContacts' => ['extras' => ['width' => 30, 'title' => $this->translator->trans('benef_new_guide_which_info_icon_3'), 'color' => 'orange', 'image' => 'build/images/icons/contacts_bleu.png', 'imageAct' => 'build/images/icons/contacts_blanc.png'], 'route' => 're_app_contact_list', 'routeParameters' => ['id' => $beneficiaireId]],
                'beneficiaire.'.$menuTrad.'.mesNotes' => ['extras' => ['width' => 35, 'title' => $this->translator->trans('benef_new_guide_which_info_icon_4'), 'color' => 'lightPink', 'image' => 'build/images/icons/notes_bleu.png', 'imageAct' => 'build/images/icons/notes_blanc.png'], 'route' => 're_app_note_list', 'routeParameters' => ['id' => $beneficiaireId]],
            ];
            ...
            $arRoutes = [
                ...
                'beneficiaire.'.$menuTrad.'.mesDocuments' => ['extras' => ['color' => 'white', 'image' => 'build/images/icons/docs_bleu.png', 'imageAct' => 'build/images/icons/docs_blanc.png'], 'route' => 'document_list', 'routeParameters' => ['id' => $beneficiaireId]],
