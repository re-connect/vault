...
export default class extends Controller {
  ...
  toggle(event) {
    ...
    confirmMessage
      ? askToggleVisibilty(event, card, icons, toggleSwitch, url, confirmMessage)
      : toggleVisibility(event, card, icons, toggleSwitch, url);
  }
}

function askToggleVisibilty(event, card, icons, toggleSwitch, url, confirmMessage) {
  Swal.fire({
